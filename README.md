...
- **APIs de LLMs** - Integración con servicios de procesamiento de lenguaje natural para el análisis automático de políticas

### Despliegue
- **Docker** - Contenedorización de servicios
- **Docker Compose** - Orquestación de contenedores (frontend, backend, base de datos)
...
- **Revisión de código** mediante Pull Requests en GitHub
...
├── backend/        # API REST desarrollada con Java + Spring Boot
